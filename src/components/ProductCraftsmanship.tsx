...
import { Sparkles, ShieldCheck, Feather, Gem, CheckCircle, HeartHandshake } from 'lucide-react';
...
export const ProductCraftsmanship: React.FC<ProductCraftsmanshipProps> = ({ product }) => {
  ...
  const specs = [
    ...
    {
      label: 'Weight',
      value: isEarring ? '14.2g (Ultra Featherlight Pair)' : isBangle ? '38g (Velvet Comfort Stack)' : '18g (Silk Organza Air)',
    },
    {
      label: 'Dimensions',
      value: isEarring ? '7.2 cm Drop Length × 3.5 cm Chandelier Width' : isBangle ? 'Standard 2.4 - 2.6 Free Exchange Size' : '14 cm Bow Span × 18 cm Ribbon Tail',
    },
    {
      label: 'Closure & Fit',
      value: isEarring ? 'Comfort Push-Back with Silicone Support Disc' : isBangle ? 'Flexible Velvet / Spring Screw Kada' : 'French Alligator Hair Barrette',
    },
    {
      label: 'Stone & Accents',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <p className="text-xs sm:text-sm text-[#70605A]">
            Why Bollywood heroines and modern sweethearts choose Nakhrewali over heavy, painful traditional jewelry.
          </p>
        </div>
        ...
        <div className="border-t border-[#EAE1D7] pt-12">
          <div className="text-center max-w-xl mx-auto mb-8 space-y-1">
            ...
            <p className="text-xs text-[#70605A]">
              Follow these simple rituals to keep this piece heirloom-fresh for every wedding and romantic dinner.
            </p>
          </div>
