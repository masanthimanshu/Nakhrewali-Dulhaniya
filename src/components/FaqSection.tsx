  ...
  const faqs: FaqItem[] = [
    {
      ...
      category: "sizing",
      question:
        "Bro, I don’t know her earring or bangle size. What should I buy?",
      answer:
    ...
    },
    {
      ...
      category: "shipping",
      question:
        "How fast will my order arrive? Can I get it for an upcoming date or birthday?",
      answer:
    ...
    },
    {
      ...
      category: "quality",
      question:
        "Will the jewelry turn black, tarnish, or cause skin allergies?",
      answer:
    ...
    },
    {
      ...
      category: "gifting",
      question:
        "What if she wants a different color or doesn’t like the design?",
      answer:
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-2 mb-10">
          ...
          <p className="text-xs sm:text-sm text-[#70605A]">
            Everything you need to know about gifting, sizing, discreet
