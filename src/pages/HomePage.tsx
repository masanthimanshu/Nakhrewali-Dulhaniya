...
export const HomePage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <section id="catalog-section" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pb-6 border-b border-[#EAE1D7]">
          <div className="flex items-center space-x-2 text-xs text-[#70605A] overflow-x-auto w-full sm:w-auto no-scrollbar">
            ...
            <span className="font-semibold text-[#1C1412] shrink-0">Filter:</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-xs sm:text-sm text-[#6E5D57] leading-relaxed">
                Every parcel from <strong>nakhrewalidulhaniya.com</strong> is packed to evoke pure emotion. You choose her favorite piece across our 4 ranges, and our atelier completes the magic with rose-scented potpourri, a signature Gulabi velvet box, and a hand-poured crimson wax seal enclosing your personalized Bollywood love letter.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-2">
                <div className="bg-[#FAF7F2] p-4 rounded-2xl border border-[#EAE1D7]">
                  <span className="text-lg">💌</span>
                  <h5 className="text-xs font-bold text-[#1C1412] mt-1.5">Wax-Sealed Letter</h5>
                  <p className="text-[11px] text-[#8C7A75] mt-0.5">Calligraphy parchment letter included free.</p>
                </div>
                <div className="bg-[#FAF7F2] p-4 rounded-2xl border border-[#EAE1D7]">
                  <span className="text-lg">👑</span>
                  <h5 className="text-xs font-bold text-[#1C1412] mt-1.5">Weightless Craft</h5>
                  <p className="text-[11px] text-[#8C7A75] mt-0.5">Hollow brass core for pain-free dancing.</p>
                </div>
                <div className="bg-[#FAF7F2] p-4 rounded-2xl border border-[#EAE1D7]">
                  <span className="text-lg">🌹</span>
                  <h5 className="text-xs font-bold text-[#1C1412] mt-1.5">Gulabi Velvet Box</h5>
                  <p className="text-[11px] text-[#8C7A75] mt-0.5">Scented rose potpourri keepsake box.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-[#FAF7F2] p-8 rounded-3xl border border-[#EAE1D7] shadow-xs text-center space-y-4">
              ...
              <p className="text-xs text-[#6E5D57] max-w-sm mx-auto leading-relaxed">
                Mix and match pieces across Haye Jhumka, Bole Chudiyan, and Yeh Reshmi Zulfen to create a custom royal gift box with automatic 15% privilege savings.
              </p>
              <button
